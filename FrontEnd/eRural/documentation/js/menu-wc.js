...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">e-rural documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-4d231a30890d4d92425a6e9a770b07c1"' : 'data-target="#xs-components-links-module-AppModule-4d231a30890d4d92425a6e9a770b07c1"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-4d231a30890d4d92425a6e9a770b07c1"' :
                                            'id="xs-components-links-module-AppModule-4d231a30890d4d92425a6e9a770b07c1"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/AjudaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AjudaComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/AreaProdutorComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AreaProdutorComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/InicioClienteComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">InicioClienteComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/InicioProdutorComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">InicioProdutorComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/ListaProdutoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ListaProdutoComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ProdutoProdutorComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ProdutoProdutorComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/ProdutoDeleteComponent.html" data-type="entity-link">ProdutoDeleteComponent</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
